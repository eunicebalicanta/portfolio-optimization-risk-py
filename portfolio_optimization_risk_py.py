# -*- coding: utf-8 -*-
"""portfolio_optimization_risk_py.ipynb
...
- Sharpe Ratio: Maximizes return per unit of risk by considering the excess return and risk-free rate (Bank of Canada 10-Year Benchmark Bond Yield on October 26, 2024 = 3.25%)
...
# Assign Risk-Free Rate as the Government 10-Year Benchmark Bond Yield
def negative_sharpe_ratio(weights, returns, risk_free_rate=0.0325):
...
def plot_efficient_frontier(returns, weights_mean_variance, num_portfolios=10000):
    ...
    for i in range(num_portfolios):
        ...
        results[2, i] = (portfolio_return - 0.0325) / portfolio_std_dev
